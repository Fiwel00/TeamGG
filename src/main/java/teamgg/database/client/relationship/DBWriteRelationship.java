				...
				if (relationship.isExistInDb() == false) {
					Document newRelationshipDocument = new Document(RelationshipDBFields.ACCOUNT_ID_1.toString(),
							relationship.getAccountId1())
									.append(RelationshipDBFields.ACCOUNT_ID_2.toString(), relationship.getAccountId2())
									.append(RelationshipDBFields.FIRST_ENCOUNTER_AGAINST.toString(), relationship.getFirstEncounterAgainst())
									.append(RelationshipDBFields.FIRST_ENCOUNTER_WITH.toString(), relationship.getFirstEncounterWith())
									.append(RelationshipDBFields.LAST_ENCOUNTER_AGAINST.toString(), relationship.getLastEncounterAgainst())
									.append(RelationshipDBFields.LAST_ENCOUNTER_WITH.toString(), relationship.getLastEncounterWith())
									.append(RelationshipDBFields.LOST_AGAINST.toString(), relationship.getLostAgainst())
					...
					Bson updateFirstEncounterAgainst = set(RelationshipDBFields.FIRST_ENCOUNTER_AGAINST.toString(),	relationship.getFirstEncounterAgainst());
					Bson updateFirstEncounterWith = set(RelationshipDBFields.FIRST_ENCOUNTER_WITH.toString(), relationship.getFirstEncounterWith());
					Bson updateLastEncounterAgainst = set(RelationshipDBFields.LAST_ENCOUNTER_AGAINST.toString(), relationship.getLastEncounterAgainst());
					Bson updateLastEncounterWith = set(RelationshipDBFields.LAST_ENCOUNTER_WITH.toString(), relationship.getLastEncounterWith());
					Bson updateLostAgainst = set(RelationshipDBFields.LOST_AGAINST.toString(), relationship.getLostAgainst());
					Bson updateLostWith = set(RelationshipDBFields.LOST_WITH.toString(), relationship.getLostWith());
					Bson updateWonAgainst = set(RelationshipDBFields.WON_AGAINST.toString(), relationship.getWonAgainst());
